...
export const Faqdata: FaqType[] = [
  {
    heading: "1. What services does Kerodevs offer?",
    subheading: "Kerodevs offers web development, mobile app development, custom software, AI solutions, UI/UX design, and cloud & DevOps services.",
  },
  {
    heading: "2. How long does a project take?",
    subheading: "Project timelines vary based on complexity. Simple websites take 1-2 weeks, while complex applications can take 4-12 weeks. We provide a clear timeline before starting.",
  },
  {
    heading: "3. Do you provide post-launch support?",
    subheading: "Yes, we offer dedicated post-launch support including bug fixes, updates, and feature additions to ensure your product runs flawlessly.",
  },
];

          ...
          <div className="kf-grid">
            ...
            <div>
              <div className="kf-logo">
                ...
                <img src="/images/logo/footerlogo.png"  className="kf-logo-img h-16 w-48" alt="" />
              </div>
              ...
              <div className="kf-socials">
                <Link className="kf-social" href="https://www.linkedin.com/company/kerodevs" aria-label="LinkedIn">
                ...
                <Link className="kf-social" href="https://web.facebook.com/profile.php?id=61590835793791" aria-label="Facebook">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M22 12.06C22 6.505 17.523 2 12 2S2 6.505 2 12.06c0 5.022 3.657 9.184 8.438 9.94v-7.03H7.898v-2.91h2.54V9.845c0-2.506 1.492-3.89 3.776-3.89 1.094 0 2.238.195 2.238.195v2.459h-1.26c-1.243 0-1.63.771-1.63 1.562v1.877h2.773l-.443 2.91h-2.33v7.03C18.343 21.244 22 17.082 22 12.06z"/></svg>
                </Link>
                <Link className="kf-social" href="https://www.instagram.com/kerodevs/" aria-label="Instagram">

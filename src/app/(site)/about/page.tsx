...
//  OR for pages router:  pages/about.tsx
// ─────────────────────────────────────────────
"use client";
...
const AboutPage = () => {
  return (
    <>
      ...
      <section
        style={{ background: "#ffffff", fontFamily: "'Outfit', sans-serif", position: "relative", paddingTop: "80px", paddingBottom: "80px" }}
      >
        {/* Decorative blobs */}
        ...
        <div className="container relative z-10">
          ...
          <div className="text-center mt-16">
            ...
            <p
              className="max-w-4xl mx-auto md:text-lg md:leading-9 leading-8 "
              style={{ fontFamily: "'Outfit', sans-serif", fontWeight: 400, color: "#475569", letterSpacing: "0.2px" }}
            >
              At Kerodevs, we help businesses grow through innovative web development, mobile app
              development, and custom software solutions. Our team creates secure, scalable, and
              user-focused digital products that solve real business challenges and deliver
              measurable results.
              <br /><br />
              By combining modern technology, creative design, and strategic thinking, we build
              high-performance applications that support digital transformation and long-term
              success. From startups to enterprises, Kerodevs is committed to delivering reliable,
              future-ready solutions that help businesses stay ahead in a competitive market.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {/* Card 1 — Mission */}
            <div
              className="rounded-3xl p-8 md:p-10 h-[320px] flex flex-col justify-between transition-all duration-500 hover:scale-105 hover:-translate-y-1"
            ...
            >
              <span
                className="w-fit text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-full"
              ...
              <div>
                ...
                <p style={{ fontFamily: "'Outfit', sans-serif", fontWeight: 400, color: "#94a3b8", lineHeight: 1.75, fontSize: "15px" }}>
                  To empower businesses through innovative software development services,
                  cutting-edge technology, and scalable digital solutions that improve efficiency,
            ...
            >
              ...
              <div>
                ...
                <div className="w-8 h-0.5 mb-4 rounded-full" style={{ background: "linear-gradient(90deg,#1d4ed8,#38bdf8)" }} />
                <p style={{ fontFamily: "'Outfit', sans-serif", fontWeight: 400, color: "#94a3b8", lineHeight: 1.75, fontSize: "15px" }}>
                  To become a globally recognized technology company by creating intelligent
                  digital products, transforming industries through innovation, and shaping the
                  future with AI-driven solutions.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <div className="w-8 h-0.5 mb-4 rounded-full" style={{ background: "linear-gradient(90deg,#1d4ed8,#38bdf8)" }} />
                <p style={{ fontFamily: "'Outfit', sans-serif", fontWeight: 400, color: "#94a3b8", lineHeight: 1.75, fontSize: "15px" }}>
                  We leverage modern technologies, agile development methodologies, and
                  data-driven strategies to deliver secure, scalable, and future-ready software
                  solutions tailored to our clients' unique business needs.
                </p>
              </div>
            </div>
